...
import GuidanceHub from "@/app/dashboard/student/guidance/_components/GuidanceHub";
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="space-y-1.5">
        ...
        <p className="text-[var(--text-muted)] text-sm max-w-2xl">
          Öğrencilerinizin gördüğü rehberlik yazıları, motivasyon videoları ve
          üniversite kılavuzları. Görüşmelerde önerebileceğiniz içerikleri
      ...
      <GuidanceHub
        ...
        basePath="/dashboard/teacher/guidance"
      />
    </div>
  );
}
