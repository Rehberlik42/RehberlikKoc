...
export default function QuickAddKitapOkumaModal({
  onClose,
  studentId,
  teacherId,
  planDate,
  ...
  return createPortal(
    <div className="fixed inset-0 z-50">
      ...
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="quick-kitap-title"
        ...
        <div className="flex-1 space-y-4 overflow-y-auto px-5 py-5">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder="Kitap adı veya kısa not…"
              className={inputCls}
            />
          </div>
