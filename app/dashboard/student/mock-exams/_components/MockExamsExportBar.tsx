...
export default function MockExamsExportBar() {
  ...
  return (
    <>
      ...
      <PdfExportButton
        targetId="mock-exams-export-root"
        filenamePrefix="mindora-deneme-analizi"
        reportTitle="MINDORA Raporu · Deneme Analizi"
